...
class _PopoverScaffoldState extends State<PopoverScaffold> {
  ...
  BoxConstraints _computePopoverConstraints() {
    ...
    if (widget.boundaryKey != null) {
      ...
      final boundaryBox =
          widget.boundaryKey!.currentContext!.findRenderObject() as RenderBox;
        ...
        child: Follower.withAligner(
          ...
          aligner: FunctionalAligner(
            delegate: (globalLeaderRect, followerSize) =>
                widget.popoverGeometry.aligner.align(globalLeaderRect,
                    followerSize, _screenSize, widget.boundaryKey),
          ),
...
class FunctionalPopoverAligner implements PopoverAligner {
  ...
  final FollowerAlignment Function(Rect globalLeaderRect, Size followerSize,
      Size screenSize, GlobalKey? boundaryKey) _aligner;
...
class DropdownListPopoverAligner implements PopoverAligner {
  ...
  @override
  FollowerAlignment align(Rect globalLeaderRect, Size followerSize,
      Size screenSize, GlobalKey<State<StatefulWidget>>? boundaryKey) {
    final boundsBox =
...
class _PreventPrioritizedIntentsFromBubblingUp
  ...
  bool isEnabled(PrioritizedIntents intent, [BuildContext? context]) {
    ...
    for (final Intent candidateIntent in intent.orderedIntents) {
      ...
      if (candidateAction != null &&
          _isActionEnabled(candidateAction, candidateIntent, context)) {
...
class RoundedRectanglePopoverAppearance extends StatefulWidget {
  ...
  @override
  State<RoundedRectanglePopoverAppearance> createState() =>
      _RoundedRectanglePopoverAppearanceState();
}

class _RoundedRectanglePopoverAppearanceState
    extends State<RoundedRectanglePopoverAppearance>

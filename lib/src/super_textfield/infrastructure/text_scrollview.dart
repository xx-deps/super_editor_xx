    ...
    if (isMultiline) {
      return [
        Positioned(
          ...
          top: 0,
          child: IgnorePointer(
            child: Container(height: _mulitlineFieldAutoScrollGap, color: Colors.purpleAccent.withValues(alpha: 0.5)),
          ),
        ),
        Positioned(
          left: 0,
      ...
      return [
        Positioned(
          ...
          top: 0,
          bottom: 0,
          child: Container(width: _singleLineFieldAutoScrollGap, color: Colors.purpleAccent.withValues(alpha: 0.5)),
        ),
        Positioned(
          right: 0,
          top: 0,
...
class TextScrollController with ChangeNotifier {
  ...
  void updateAutoScrollingForTouchOffset({required Offset userInteractionOffsetInViewport}) {
    if (_delegate == null) {
  ...
  void _autoScrollToTheLeft(Duration dt, double distanceFromAutoScrollBoundary) {
    ...
    _setScrollOffset(max(_scrollOffset - _calculateAutoScrollDistance(dt, distanceFromAutoScrollBoundary), 0));
  ...
  void _autoScrollToTheRight(Duration dt, double distanceFromAutoScrollBoundary) {
    ...
    _setScrollOffset(min(_scrollOffset + scrollDistance, _delegate!.endScrollOffset));
    _log.finer(' - _scrollOffset after: $_scrollOffset');
  ...
  void ensureExtentIsVisible() {
    ...
    final extentCharacterRectInViewportSpace = _delegate!.getViewportCharacterRectAtPosition(

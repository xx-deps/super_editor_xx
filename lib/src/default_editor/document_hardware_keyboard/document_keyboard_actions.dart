...
ExecutionInstruction scrollOnPageUpKeyPress({required SuperEditorContext editContext, required KeyEvent keyEvent}) {
...
ExecutionInstruction scrollOnPageDownKeyPress({required SuperEditorContext editContext, required KeyEvent keyEvent}) {
  if (keyEvent is! KeyDownEvent && keyEvent is! KeyRepeatEvent) {
    return ExecutionInstruction.continueExecution;
  }
...
ExecutionInstruction scrollOnCtrlOrCmdAndHomeKeyPress({
  ...
  scroller.animateTo(scroller.minScrollExtent, duration: const Duration(milliseconds: 150), curve: Curves.decelerate);
...
ExecutionInstruction scrollOnCtrlOrCmdAndEndKeyPress({
  ...
  scroller.animateTo(scroller.maxScrollExtent, duration: const Duration(milliseconds: 150), curve: Curves.decelerate);
...
ExecutionInstruction blockControlKeys({required SuperEditorContext editContext, required KeyEvent keyEvent}) {
...
ExecutionInstruction toggleInteractionModeWhenCmdOrCtrlPressed({
  ...
  if (keyEvent.isPrimaryShortcutKeyPressed && !editContext.composer.isInInteractionMode.value) {
    ...
    editContext.editor.execute([const ChangeInteractionModeRequest(isInteractionModeDesired: true)]);
  } else if (editContext.composer.isInInteractionMode.value) {
    editorKeyLog.fine("De-activating editor interaction mode");
    editContext.editor.execute([const ChangeInteractionModeRequest(isInteractionModeDesired: false)]);
  }
...
ExecutionInstruction sendKeyEventToMacOs({required SuperEditorContext editContext, required KeyEvent keyEvent}) {
...
ExecutionInstruction pasteWhenCmdVIsPressed({required SuperEditorContext editContext, required KeyEvent keyEvent}) {
  if (keyEvent is! KeyDownEvent && keyEvent is! KeyRepeatEvent) {
    return ExecutionInstruction.continueExecution;
  }
...
ExecutionInstruction selectAllWhenCmdAIsPressed({required SuperEditorContext editContext, required KeyEvent keyEvent}) {
  if (keyEvent is! KeyDownEvent && keyEvent is! KeyRepeatEvent) {
    return ExecutionInstruction.continueExecution;
  }
...
ExecutionInstruction copyWhenCmdCIsPressed({required SuperEditorContext editContext, required KeyEvent keyEvent}) {
  if (keyEvent is! KeyDownEvent && keyEvent is! KeyRepeatEvent) {
    return ExecutionInstruction.continueExecution;
  }
...
ExecutionInstruction cutWhenCmdXIsPressed({required SuperEditorContext editContext, required KeyEvent keyEvent}) {
  if (keyEvent is! KeyDownEvent && keyEvent is! KeyRepeatEvent) {
    return ExecutionInstruction.continueExecution;
  }
...
ExecutionInstruction cmdBToToggleBold({required SuperEditorContext editContext, required KeyEvent keyEvent}) {
  if (keyEvent is! KeyDownEvent && keyEvent is! KeyRepeatEvent) {
    return ExecutionInstruction.continueExecution;
  }
...
ExecutionInstruction cmdIToToggleItalics({required SuperEditorContext editContext, required KeyEvent keyEvent}) {
  if (keyEvent is! KeyDownEvent && keyEvent is! KeyRepeatEvent) {
    return ExecutionInstruction.continueExecution;
  }
...
ExecutionInstruction moveUpAndDownWithArrowKeys({required SuperEditorContext editContext, required KeyEvent keyEvent}) {
  if (keyEvent is! KeyDownEvent && keyEvent is! KeyRepeatEvent) {
    return ExecutionInstruction.continueExecution;
  }
...
ExecutionInstruction moveLeftAndRightWithArrowKeys({
  ...
  const arrowKeys = [LogicalKeyboardKey.arrowLeft, LogicalKeyboardKey.arrowRight];
  if (!arrowKeys.contains(keyEvent.logicalKey)) {
    return ExecutionInstruction.continueExecution;
  }
...
ExecutionInstruction moveToLineStartWithHome({required SuperEditorContext editContext, required KeyEvent keyEvent}) {
  if (keyEvent is! KeyDownEvent && keyEvent is! KeyRepeatEvent) {
    return ExecutionInstruction.continueExecution;
  }
...
ExecutionInstruction moveToLineEndWithEnd({required SuperEditorContext editContext, required KeyEvent keyEvent}) {
  if (keyEvent is! KeyDownEvent && keyEvent is! KeyRepeatEvent) {
    return ExecutionInstruction.continueExecution;
  }
...
ExecutionInstruction deleteToStartOfLineWithCmdBackspaceOnMac({
  ...
  didMove = editContext.commonOps.moveCaretUpstream(expand: true, movementModifier: MovementModifier.line);
...
ExecutionInstruction deleteToEndOfLineWithCmdDeleteOnMac({
  ...
  didMove = editContext.commonOps.moveCaretDownstream(expand: true, movementModifier: MovementModifier.line);
...
ExecutionInstruction deleteWordUpstreamWithAltBackspaceOnMac({
  ...
  didMove = editContext.commonOps.moveCaretUpstream(expand: true, movementModifier: MovementModifier.word);
...
ExecutionInstruction deleteWordDownstreamWithAltDeleteOnMac({
  ...
  didMove = editContext.commonOps.moveCaretDownstream(expand: true, movementModifier: MovementModifier.word);

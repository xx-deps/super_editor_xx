...
final defaultRequestHandlers = List.unmodifiable(<EditRequestHandler>[
  ...
  (editor, request) => request is InsertNodeBeforeNodeRequest
      ? InsertNodeBeforeNodeCommand(
          existingNodeId: request.existingNodeId,
          newNode: request.newNode,
        )
      : null,
  ...
  (editor, request) =>
      ...
      : null,
  (editor, request) =>
      request is DeleteUpstreamAtBeginningOfNodeRequest &&
  ...
  (editor, request) => request is IndentParagraphRequest
      ? IndentParagraphCommand(request.nodeId)
      : null,
  (editor, request) => request is UnIndentParagraphRequest
      ? UnIndentParagraphCommand(request.nodeId)
      : null,
  (editor, request) => request is SetParagraphIndentRequest
      ? SetParagraphIndentCommand(request.nodeId, level: request.level)
      : null,
  ...
  (editor, request) => request is ConvertTextNodeToParagraphRequest
      ? ConvertTextNodeToParagraphCommand(
          nodeId: request.nodeId,
          newMetadata: request.newMetadata,
        )
      : null,

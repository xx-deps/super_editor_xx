...
void main() {
  group('SuperTextField', () {
    testGoldensOnAndroid(
      "multi-line accounts for padding when jumping scroll position down",
      (tester) async {
        ...
        final builder =
            GoldenBuilder.column(wrap: (child) => Row(children: [child]))
              ..addScenario(
    ...
    testGoldensOnAndroid(
      "multi-line accounts for padding when jumping scroll position up",
      (tester) async {
        final controller = AttributedTextEditingController(
          text: AttributedText(
            "First line\nSecond Line\nThird Line\nFourth Line",

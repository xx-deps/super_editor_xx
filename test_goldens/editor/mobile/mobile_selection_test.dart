    ...
    group("mobile drag handles", () {
      testGoldensOnAndroid("with caret change colors", (tester) async {
        final testContext =
            await tester //
                ...
                .withiOSToolbarBuilder(
                  (context, mobileToolbarKey, focalPoint) => const SizedBox(),
                )
        ...
        await expectLater(
          ...
          matchesGoldenFile(
            "goldens/supereditor_android_collapsed_handle_color.png",
          ),
        );
      });
      ...
      testGoldensOnAndroid("with selection change colors", (tester) async {
        ...
        await expectLater(
          find.byType(MaterialApp),
          matchesGoldenFile(
            "goldens/supereditor_android_expanded_handle_color.png",
          ),
        );
      });
      ...
      testGoldensOniOS("with caret change colors", (tester) async {
        ...
        await expectLater(
          find.byType(MaterialApp),
          matchesGoldenFile(
            "goldens/supereditor_ios_collapsed_handle_color.png",
          ),
        );
      });
      ...
      testGoldensOniOS("with selection change colors", (tester) async {
        ...
        await expectLater(
          find.byType(MaterialApp),
          matchesGoldenFile(
            "goldens/supereditor_ios_expanded_handle_color.png",
          ),
        );
      });
    });
      ...
      group('Android', () {
        ...
        _testParagraphSelection(
          ...
          (tester, docKey, dragLine) async {
            ...
            final dragDelta =
                SuperEditorInspector.findDeltaBetweenCharactersInTextNode(
                  "1",
                  34,
                  28,
                );
            final handleRectGlobal =
                SuperEditorInspector.findMobileCaretDragHandle().globalRect;
            ...
            dragLine.value = _Line(
              handleRectGlobal.center,
              centerOfVisualHandle + dragDelta,
            );
        ...
        _testParagraphSelection(
          ...
          (tester, docKey, dragLine) async {
            ...
            dragLine.value = _Line(
              handleRectGlobal.center,
              handleRectGlobal.center + dragDelta,
            );
        ...
        _testParagraphSelection(
          ...
          (tester, docKey, dragLine) async {
            ...
            final handleRectGlobal =
                SuperEditorInspector.findMobileBaseDragHandle().globalRect;
            await tester.dragFrom(handleRectGlobal.center, dragDelta);
        ...
        _testParagraphSelection(
          ...
          (tester, docKey, dragLine) async {
            await tester.doubleTapAtDocumentPosition(
              const DocumentPosition(
                nodeId: "1",
                nodePosition: TextNodePosition(offset: 38),
              ),
            );
            await tester.pumpAndSettle();
            ...
            final handleRectGlobal =
                SuperEditorInspector.findMobileExtentDragHandle().globalRect;
            await tester.dragFrom(handleRectGlobal.center, dragDelta);
      ...
      group('iOS', () {
        ...
        _testParagraphSelection(
          ...
          (tester, docKey, dragLine) async {
            ...
            final handleRectGlobal =
                SuperEditorInspector.findMobileCaret().globalRect;
            await tester.dragFrom(handleRectGlobal.center, dragDelta);
...
class _DragLinePaint extends StatelessWidget {
  const _DragLinePaint({Key? key, required this.line, required this.child})
    : super(key: key);
...
class _DragLinePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    _paint.shader = ui.Gradient.linear(_line.from, _line.to, [

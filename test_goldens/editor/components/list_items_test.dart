...
Future<void> main() async {
  ...
  group('SuperEditor > list items', () {
    group('unordered', () {
      testGoldensOnMac('aligns the dot vertically with the text', (
        tester,
      ) async {
        await tester //
            .createDocument()
        ...
        await screenMatchesGolden(
          tester,
          'super_editor_list_item_unordered_aligns_dot_with_text_with_font_sizes',
        );
      });

      testGoldensOnMac(
        'aligns the dot vertically with the text with a line multiplier',
        (tester) async {
          await tester //
              .createDocument()
              .withCustomContent(
      ...
      testGoldensOnMac('allows customizing the dot size with stylesheet', (
        tester,
      ) async {
        await tester //
            .createDocument()
        ...
        await screenMatchesGolden(
          tester,
          'super_editor_list_item_unordered_custom_dot_size_stylesheet',
        );
      });

      testGoldensOnMac(
        'allows customizing the dot size with component builder',
        (tester) async {
          await tester //
              .createDocument()
              .fromMarkdown('- Item 1')
              ...
              .withAddedComponents([
                const _ListItemWithCustomStyleBuilder(
                  dotStyle: ListItemDotStyle(size: Size(14, 14)),
                ),
              ])
              .pump();
          ...
          await screenMatchesGolden(
            tester,
            'super_editor_list_item_unordered_custom_dot_size_component_builder',
          );
        },
      );

      testGoldensOnMac('allows customizing the dot shape with stylesheet', (
        tester,
      ) async {
        await tester //
            .createDocument()
        ...
        await screenMatchesGolden(
          tester,
          'super_editor_list_item_unordered_custom_dot_shape_stylesheet',
        );
      });

      testGoldensOnMac('allows customizing the dot size with component builder', (
        tester,
      ) async {
        await tester //
            .createDocument()
            ...
            .withAddedComponents([
              const _ListItemWithCustomStyleBuilder(
                dotStyle: ListItemDotStyle(shape: BoxShape.rectangle),
              ),
            ])
            .pump();
        ...
        await screenMatchesGolden(
          tester,
          'super_editor_list_item_unordered_custom_dot_shape_component_builder',
        );
      });

      testGoldensOnMac('allows customizing the dot color with stylesheet', (
        tester,
      ) async {
        await tester //
            .createDocument()
        ...
        await screenMatchesGolden(
          tester,
          'super_editor_list_item_unordered_custom_dot_color_stylesheet',
        );
      });

      testGoldensOnMac(
        'allows customizing the dot color with component builder',
        (tester) async {
          await tester //
              .createDocument()
              .fromMarkdown('- Item 1')
              ...
              .withAddedComponents([
                const _ListItemWithCustomStyleBuilder(
                  dotStyle: ListItemDotStyle(color: Colors.red),
                ),
              ])
              .pump();
          ...
          await screenMatchesGolden(
            tester,
            'super_editor_list_item_unordered_custom_dot_color_component_builder',
          );
        },
      );
    });
    ...
    group('ordered', () {
      testGoldensOnMac('aligns the dot vertically with the text', (
            ...
            .withCustomContent(
              MutableDocument(
                nodes: [
                  ...
                  _createListItemNode(
                    text: 'Font size of 10',
                    fontSize: 10,
                    listItemType: ListItemType.ordered,
                  ),
                  _createListItemNode(
                    text: 'Font size of 12',
                    fontSize: 12,
                    listItemType: ListItemType.ordered,
                  ),
                  _createListItemNode(
                    text: 'Font size of 14',
                    fontSize: 14,
                    listItemType: ListItemType.ordered,
                  ),
                  _createListItemNode(
                    text: 'Font size of 16',
                    fontSize: 16,
                    listItemType: ListItemType.ordered,
                  ),
                  _createListItemNode(
                    text: 'Font size of 18',
                    fontSize: 18,
                    listItemType: ListItemType.ordered,
                  ),
                  _createListItemNode(
                    text: 'Font size of 24',
                    fontSize: 24,
                    listItemType: ListItemType.ordered,
                  ),
                  _createListItemNode(
                    text: 'Font size of 40',
                    fontSize: 40,
                    listItemType: ListItemType.ordered,
                  ),
                ],
        ...
        await screenMatchesGolden(
          tester,
          'super_editor_list_item_ordered_aligns_dot_with_text_with_font_sizes',
        );
      });
      ...
      testGoldensOnMac(
        'allows customizing the numeral as lower roman with stylesheet',
        (tester) async {
          ...
          await screenMatchesGolden(
            tester,
            'super_editor_list_item_ordered_lower_roman_numeral_stylesheet',
          );
        },
      );

      testGoldensOnMac(
        'allows customizing the numeral as lower roman with component_builder',
        (tester) async {
          await _pumpOrderedListItemStyleTestApp(
            tester,
            style: OrderedListNumeralStyle.lowerRoman,
          ...
          await screenMatchesGolden(
            tester,
            'super_editor_list_item_ordered_lower_roman_numeral_component_builder',
          );
        },
      );

      testGoldensOnMac(
        'allows customizing the numeral as upper roman with stylesheet',
        (tester) async {
          await _pumpOrderedListItemStyleTestApp(
            tester,
          ...
          await screenMatchesGolden(
            tester,
            'super_editor_list_item_ordered_upper_roman_numeral_stylesheet',
          );
        },
      );

      testGoldensOnMac(
        'allows customizing the numeral as upper roman with component builder',
        (tester) async {
          await _pumpOrderedListItemStyleTestApp(
            tester,
            style: OrderedListNumeralStyle.upperRoman,
          ...
          await screenMatchesGolden(
            tester,
            'super_editor_list_item_ordered_upper_roman_numeral_component_builder',
          );
        },
      );

      testGoldensOnMac(
        'allows customizing the numeral as lower alpha with stylesheet',
        (tester) async {
          await _pumpOrderedListItemStyleTestApp(
            tester,
          ...
          await screenMatchesGolden(
            tester,
            'super_editor_list_item_ordered_lower_alpha_numeral_stylesheet',
          );
        },
      );

      testGoldensOnMac(
        'allows customizing the numeral as lower alpha with component builder',
        (tester) async {
          await _pumpOrderedListItemStyleTestApp(
            tester,
            style: OrderedListNumeralStyle.lowerAlpha,
          ...
          await screenMatchesGolden(
            tester,
            'super_editor_list_item_ordered_lower_alpha_numeral_component_builder',
          );
        },
      );

      testGoldensOnMac(
        'allows customizing the numeral as upper alpha with stylesheet',
        (tester) async {
          await _pumpOrderedListItemStyleTestApp(
            tester,
          ...
          await screenMatchesGolden(
            tester,
            'super_editor_list_item_ordered_upper_alpha_numeral_stylesheet',
          );
        },
      );

      testGoldensOnMac(
        'allows customizing the numeral as upper alpha with component builder',
        (tester) async {
          await _pumpOrderedListItemStyleTestApp(
            tester,
            style: OrderedListNumeralStyle.upperAlpha,
          ...
          await screenMatchesGolden(
            tester,
            'super_editor_list_item_ordered_upper_alpha_numeral_component_builder',
          );
        },
      );
    });
...
Future<void> _pumpOrderedListItemStyleTestApp(
  ...
  await tester //
      ...
      .withAddedComponents([
        if (!fromStylesheet)
          _ListItemWithCustomStyleBuilder(numeralStyle: style),
      ])
      .pump();
}
...
class _ListItemWithCustomStyleBuilder implements ComponentBuilder {
  ...
  SingleColumnLayoutComponentViewModel? createViewModel(
    ...
    final viewModel = const ListItemComponentBuilder().createViewModel(
      document,
      node,
    );
    ...
    } else if (viewModel is OrderedListItemComponentViewModel &&
        numeralStyle != null) {

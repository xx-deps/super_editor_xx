...
void main() {
  group("Super Editor > inline widgets >", () {
    testWidgetsOnArbitraryDesktop(
      "can insert an inline widget in the middle of typing",
      (tester) async {
        ...
        expect(
          ...
          AttributedText("Hello  inline widgets", null, {
    ...
    testWidgetsOnArbitraryDesktop(
      "can backspace delete an inline placeholder",
      (tester) async {
        final editor = await _pumpScaffold(tester);
    ...
    testWidgetsOnArbitraryDesktop(
      "can select text and apply a style change without losing placeholder",
      (tester) async {
        final editor = await _pumpScaffold(tester);
    ...
    testWidgetsOnArbitraryDesktop(
      "can insert an inline widget with attributions in an empty paragraph",
      (tester) async {
        final editor = await _pumpScaffold(tester);

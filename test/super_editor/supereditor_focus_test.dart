...
void main() {
  group('SuperEditor', () {
    group('autofocus', () {
      testWidgets(
        'does not claim focus when autofocus is false',
        (tester) async {
          ...
          await tester //
              ...
              .withSingleParagraph()
              .withInputSource(
                inputAndGestureVariants.currentValue!.inputSource,
              )
              .withGestureMode(
                inputAndGestureVariants.currentValue!.gestureMode,
              )
              .autoFocus(false)
              .pump();
      ...
      testWidgets(
        'claims focus by gesture when autofocus is false',
        (tester) async {
          // Configure and render a document.
          await tester //
              .createDocument()
    ...
    group("throws away stale selection after re-focus", () {
      group("with caret", () {
        testWidgetsOnAllPlatforms("when content type changes", (tester) async {
          ...
          final testContext = await _pumpFocusChangeLayoutWithSingleParagraph(
            tester,
        ...
        testWidgetsOnAllPlatforms("when it no longer fits in text", (
          tester,
        ) async {
          final focusNode = FocusNode();
          final testContext = await _pumpFocusChangeLayoutWithSingleParagraph(
            ...
            DeleteContentRequest(
              documentRange: DocumentRange(
                start: DocumentPosition(
                  nodeId: textNode.id,
                  nodePosition: textNode.beginningPosition,
                ),
                end: DocumentPosition(
                  nodeId: textNode.id,
                  nodePosition: textNode.endPosition,
                ),
              ),
            ),
          ]);
      ...
      group("with expanded selection within a node", () {
        testWidgetsOnAllPlatforms("when downstream no longer fits", (
          tester,
        ) async {
      ...
      group("with expanded selection across nodes", () {
        testWidgetsOnAllPlatforms(
          "when the base and extent content type changes",
          (tester) async {
            final focusNode = FocusNode();
            final testContext = await _pumpFocusChangeLayoutWithTwoParagraphs(
              tester,
              editorFocusNode: focusNode,
            );
        ...
        testWidgetsOnAllPlatforms("when the base content type changes", (
          tester,
        ) async {
          final focusNode = FocusNode();
          final testContext = await _pumpFocusChangeLayoutWithTwoParagraphs(
        ...
        testWidgetsOnAllPlatforms("when the extent content type changes", (
          tester,
        ) async {
          final focusNode = FocusNode();
          final testContext = await _pumpFocusChangeLayoutWithTwoParagraphs(
        ...
        testWidgetsOnAllPlatforms("when the upstream no longer fits", (
          tester,
        ) async {
          final focusNode = FocusNode();
          final testContext = await _pumpFocusChangeLayoutWithTwoParagraphs(
          ...
          final textNode =
              testContext.editor.context.document.first as TextNode;
          testContext.editor.execute([
            DeleteContentRequest(
              documentRange: DocumentRange(
                start: DocumentPosition(
        ...
        testWidgetsOnAllPlatforms("when the downstream no longer fits", (
          tester,
        ) async {
          final focusNode = FocusNode();
          final testContext = await _pumpFocusChangeLayoutWithTwoParagraphs(

...
void main() {
  group('Document selection extensions', () {
    group('getAllAttributions', () {
      test(
        'returns empty list when the selection range does not contain any attributions',
        () {
      ...
      test(
        'returns attributions that span throughout the entirety of the text',
        () {
          ...
          expect(document.getAllAttributions(selection), {
            boldAttribution,
    ...
    group('getAttributionsByType', () {
      test(
        'returns empty set when the selection range does not contain any attributions',
        () {
          final document = MutableDocument(
            nodes: [
              ParagraphNode(
          ...
          expect(
            document.getAttributionsByType<FontSizeAttribution>(selection),
            isEmpty,
          );
        },
      );
      ...
      test(
        'does not return attributions that dont apply to the entire range',
        () {
              ...
              ParagraphNode(
                ...
                text: AttributedText(
                  ...
                  AttributedSpans(
                    attributions: [
                      const SpanMarker(
                        attribution: FontSizeAttribution(14),
                        offset: 5,
                        markerType: SpanMarkerType.start,
                      ),
                      const SpanMarker(
      ...
      test('return attributions that apply to the entire range', () {
        ...
        expect(document.getAttributionsByType<FontSizeAttribution>(selection), {
          const FontSizeAttribution(14),
        });
      });
    });
  });

  ...
  group("Document selection", () {
    group("selects upstream position", () {
      ...
      test("when the positions are in the same node", () {
        const position1 = DocumentPosition(
          nodeId: "1",
          nodePosition: TextNodePosition(offset: 0),
        );
    ...
    group("knows if it contains a position", () {
      test("when the selection is collapsed", () {
        ...
        expect(
          _testDoc.doesSelectionContainPosition(selection, position),
          false,
        );
      });

      test(
        "when the selection is within one node and contains the position",
        () {
          ...
          expect(
            _testDoc.doesSelectionContainPosition(
              downstreamSelection,
              position,
            ),
            true,
          ...
          expect(
            _testDoc.doesSelectionContainPosition(upstreamSelection, position),
            true,
          );
        },
      );
      ...
      test(
        "when the selection is within one node and the position sits before selection",
        () {
          const downstreamSelection = DocumentSelection(
            base: DocumentPosition(
              nodeId: "1",
      ...
      test(
        "when the selection is within one node and the position sits after selection",
        () {
          const downstreamSelection = DocumentSelection(
            base: DocumentPosition(
              nodeId: "1",
      ...
      test(
        "when the selection is across two nodes and contains the position",
        () {
          const downstreamSelection = DocumentSelection(
            base: DocumentPosition(
              nodeId: "1",
      ...
      test(
        "when the selection is across two nodes and the position comes before the selection",
        () {
          const downstreamSelection = DocumentSelection(
            base: DocumentPosition(
              nodeId: "1",
      ...
      test(
        "when the selection is across two nodes and the position comes after the selection",
        () {
          const downstreamSelection = DocumentSelection(
            base: DocumentPosition(
              nodeId: "1",
      ...
      test(
        "when the selection is across three nodes and the position is in the middle",
        () {
          const downstreamSelection = DocumentSelection(
            base: DocumentPosition(
              nodeId: "1",

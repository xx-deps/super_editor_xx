...
void main() {
  group("Block nodes", () {
    group("move caret up", () {
      testWidgets(
        "up arrow moves text caret to upstream edge of block from node below",
        (tester) async {
          ...
          await tester.pumpWidget(
            _buildHardwareKeyboardEditor(document, composer),
          );
      ...
      testWidgets(
        "up arrow moves text caret to downstream edge of block from node below",
        (tester) async {
          final document = paragraphThenHrThenParagraphDoc();
          final composer = MutableDocumentComposer(
            initialSelection: const DocumentSelection.collapsed(
              ...
              position: DocumentPosition(
                nodeId: "3",
                nodePosition: TextNodePosition(offset: 33),
              ),
            ),
          );
          await tester.pumpWidget(
      ...
      testWidgets(
        "up arrow moves caret from upstream edge to text node above",
        (tester) async {
          final document = paragraphThenHrThenParagraphDoc();
          final composer = MutableDocumentComposer(
            initialSelection: const DocumentSelection.collapsed(
          ...
          expect(
            composer.selection!.extent.nodePosition,
            isA<TextNodePosition>(),
          );
        },
      );

      testWidgets(
        "up arrow moves caret from downstream edge to text node above",
        (tester) async {
          final document = paragraphThenHrThenParagraphDoc();
          final composer = MutableDocumentComposer(
            initialSelection: const DocumentSelection.collapsed(
      ...
      testWidgets("delete moves caret down to block from node above", (
        tester,
      ) async {
        final document = paragraphThenHrThenParagraphDoc();
        final composer = MutableDocumentComposer(
      ...
      testWidgets("backspace moves caret up to block from node below", (
        tester,
      ) async {
        final document = paragraphThenHrThenParagraphDoc();
        final composer = MutableDocumentComposer(
    ...
    group("move caret down", () {
      testWidgets("text caret moves to upstream edge of block from node above", (
        tester,
      ) async {
        final document = paragraphThenHrThenParagraphDoc();
        final composer = MutableDocumentComposer(
      ...
      testWidgets(
        "text caret moves to downstream edge of block from node above",
        (tester) async {
          final document = paragraphThenHrThenParagraphDoc();
          final composer = MutableDocumentComposer(
            initialSelection: const DocumentSelection.collapsed(
      ...
      testWidgets("upstream block caret moves to text node below", (
        tester,
      ) async {
        final document = paragraphThenHrThenParagraphDoc();
        final composer = MutableDocumentComposer(
      ...
      testWidgets("downstream block caret moves to text node below", (
        tester,
      ) async {
        final document = paragraphThenHrThenParagraphDoc();
        final composer = MutableDocumentComposer(
    ...
    group("move caret horizontally", () {
      ...
      testWidgets(
        "right arrow collapses the expanded selection around block node to a caret on the downstream edge",
        (tester) async {
          await tester
              .createDocument()
    ...
    group("deletion", () {
      testWidgets(
        "backspace moves caret to node above when caret is on upstream edge",
        (tester) async {
          final document = paragraphThenHrThenParagraphDoc();
          final composer = MutableDocumentComposer(
            initialSelection: const DocumentSelection.collapsed(
      ...
      testWidgets(
        "backspace removes block node when caret is on downstream edge",
        (tester) async {
          final document = paragraphThenHrThenParagraphDoc();
          final composer = MutableDocumentComposer(
            initialSelection: const DocumentSelection.collapsed(
      ...
      testWidgets(
        "delete moves caret to node below when caret is at downstream edge",
        (tester) async {
          final document = paragraphThenHrThenParagraphDoc();
          final composer = MutableDocumentComposer(
            initialSelection: const DocumentSelection.collapsed(
      ...
      testWidgets("delete removes block node when caret is at upstream edge", (
        tester,
      ) async {
        final document = paragraphThenHrThenParagraphDoc();
        final composer = MutableDocumentComposer(
      ...
      testWidgets("backspace removes block and part of node above", (
        tester,
      ) async {
        final document = paragraphThenHrThenParagraphDoc();
        final composer = MutableDocumentComposer(
      ...
      testWidgets("backspace removes block and part of node below", (
        tester,
      ) async {
        final document = paragraphThenHrThenParagraphDoc();
        final composer = MutableDocumentComposer(
      ...
      testWidgets("backspace removes block and merges surrounding text nodes", (
        tester,
      ) async {
        final document = paragraphThenHrThenParagraphDoc();
        final composer = MutableDocumentComposer(
      ...
      testWidgets("backspace does nothing at beginning of document", (
        tester,
      ) async {
    ...
    group("typing at boundary", () {
      ...
      testWidgets(
        "deletes empty paragraph in node above when backspace pressed from upstream edge",
        (tester) async {
...
Widget _buildHardwareKeyboardEditor(

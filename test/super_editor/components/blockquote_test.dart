...
void main() {
  group('Super Editor > Blockquote >', () {
    testWidgets("applies the textStyle from SuperEditor's styleSheet", (
      WidgetTester tester,
    ) async {
      await tester
          .createDocument() //
    ...
    group("insert newlines >", () {
      testWidgetsOnAllPlatforms(
        "inserts newline in middle and splits blockquote into two blockquotes",
      ...
      testWidgetsOnAllPlatforms(
        "inserts newline at end of blockquote to create a new empty paragraph",
        (WidgetTester tester) async {
          await tester
              .createDocument() //
              .withCustomContent(_singleBlockquoteDoc())

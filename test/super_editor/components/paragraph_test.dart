...
void main() {
  group("SuperEditor > Paragraph Component >", () {
    testWidgetsOnAllPlatforms(
      "visually updates alignment immediately after it is changed",
      (tester) async {
        final editorContext =
            await tester //
                .createDocument()
        ...
        var paragraphComponent =
            find.byType(TextComponent).evaluate().first.widget as TextComponent;
    ...
    group("block newlines >", () {
      testWidgetsOnAllPlatforms(
        "inserts newline in middle and splits paragraph into two paragraphs",
        (WidgetTester tester) async {
          ...
          expect(
            document.last.asTextNode.text.toPlainText(),
            "node in a document.",
          );
        },
      );
      ...
      testWidgetsOnAllPlatforms(
        "inserts newline at end of paragraph to create a new empty paragraph",
        (WidgetTester tester) async {
          await tester
              .createDocument() //
              .withSingleShortParagraph()
      ...
      testWidgetsOnAllPlatforms(
        "does nothing when caret is in non-deletable paragraph",
        (tester) async {
          await tester
              .createDocument()
              .withCustomContent(
    ...
    group("soft newlines >", () {
      testWidgetsOnDesktop(
        "SHIFT + ENTER inserts a soft newline in middle of paragraph",
        (tester) async {
          final editorContext =
              await tester //
                  .createDocument()
          ...
          expect(
            editorContext.document.first.asTextNode.text.toPlainText(),
            "This is the first \nnode in a document.",
          );
        },
      );
      ...
      testWidgetsOnDesktop(
        "SHIFT + ENTER inserts a soft newline at end of paragraph",
        (tester) async {
          final editorContext =
              await tester //
                  .createDocument()
    ...
    group("indentation >", () {
      testWidgetsOnDesktop("indents with Tab and un-indents with Shift+Tab", (
        tester,
      ) async {
        await tester //
            .createDocument()
      ...
      testWidgetsOnDesktop("indents with Tab when caret is in middle of text", (
        tester,
      ) async {
        await tester //
            .createDocument()
      ...
      testWidgetsOnDesktop(
        "next paragraph preserves indent, pressing Enter removes inherited indent",
        (tester) async {
          await tester //
              .createDocument()
              .withSingleParagraph()
          ...
          var newParagraph =
              SuperEditorInspector.findDocument()!.getNodeAt(1)
                  as ParagraphNode;
      ...
      testWidgetsOnDesktopAndWeb(
        "Backspace at start of text un-indents paragraph",
        (tester) async {
          await tester //
              .createDocument()
              .withSingleParagraph()

...
void main() {
  group("SuperEditor", () {
    group("applies attributions", () {
      group("when continuing existing attributions >", () {
        group("by placing caret >", () {
          ...
          testWidgetsOnAllPlatforms("text color", (tester) async {
            ...
            final text = SuperEditorInspector.findTextInComponent(
              document.first.id,
            );
      ...
      group("when selecting by tapping", () {
        testWidgetsOnAllPlatforms(
          "and typing at the end of the attributed text",
          (tester) async {
            await tester //
                .createDocument()
                .fromMarkdown("A **bold** text")
            ...
            // Place the caret at "text|".
            await tester.placeCaretInParagraph(document.first.id, 13);

            // Type at an offset that shouldn't expand any attributions.
            await tester.typeImeText(".");

            // Ensure the bold attribution was applied to the inserted text.
            expect(document, equalsMarkdown("A **bolder** text."));
          },
        );

        testWidgetsOnAllPlatforms(
          "and typing at the middle of the attributed text",
          (tester) async {
            await tester //
                .createDocument()
            ...
            await tester.placeCaretInParagraph(document.first.id, 3);
            ...
            // Ensure the bold attribution was applied to the inserted text.
            expect(document, equalsMarkdown("Another **bold** text"));
          },
        );

        testWidgetsOnAllPlatforms("and typing at the middle of a link", (
          tester,
        ) async {
          await tester //
              .createDocument()
          ...
          await tester.placeCaretInParagraph(document.first.id, 30);
          ...
          expect(
            document,
            equalsMarkdown(
              "[This is another link](https://google.com) to google.",
            ),
          );
        });
      });
      ...
      group("when selecting by the keyboard", () {
        testWidgetsOnAllPlatforms(
          ...
          (tester) async {
            ...
            // Place the caret at |text.
            await tester.placeCaretInParagraph(document.first.id, 7);
            ...
            // Ensure the bold attribution was applied to the inserted text.
            expect(document, equalsMarkdown("A **bolder** new text"));
          },
        );
        ...
        testWidgetsOnAllPlatforms(
          ...
          (tester) async {
            ...
            // Ensure the bold attribution was applied to the inserted text.
            expect(document, equalsMarkdown("A **bold** new text"));
          },
        );
        ...
        testWidgetsOnAllPlatforms("and typing at the middle of a link", (
          ...
          await tester.placeCaretInParagraph(document.first.id, 15);
          ...
          expect(
            document,
            equalsMarkdown(
              "[This is a linnk](https://google.com) pointing to google",
            ),
          );
        });
      });
      ...
      group("when collapsing the selection", () {
        testWidgetsOnMac(
          "by keyboard and typing at the end of the attributed text",
          (tester) async {
            await tester //
                .createDocument()
                .fromMarkdown("A bold text")
        ...
        testWidgetsOnMac(
          "by tapping and typing at the end of the attributed text",
          (tester) async {
            await tester //
                .createDocument()
                .fromMarkdown("A bold text")
      ...
      group("when a single node is selected", () {
        testWidgetsOnAllPlatforms("toggles attribution throughout a node", (
          tester,
        ) async {
          final context =
              await tester //
        ...
        testWidgetsOnAllPlatforms(
          "toggles attribution on a partial node selection",
          (tester) async {
            final context =
                await tester //
                    .createDocument()
        ...
        testWidgetsOnAllPlatforms(
          "toggles an attribution within a sub-range of an existing same attribution",
          (tester) async {
            final context =
                await tester //
                    .createDocument()
        ...
        testWidgetsOnAllPlatforms(
          "toggles multiple attributions throughout a node",
          (tester) async {
            final context =
                await tester //
                    .createDocument()
      ...
      group("when multiple nodes are selected", () {
        testWidgetsOnAllPlatforms(
          "toggles attribution throughout multiple nodes",
          (tester) async {
            final context =
                await tester //
                    .createDocument()
        ...
        testWidgetsOnAllPlatforms(
          ...
          (tester) async {
            ...
            expect(
              document.getNodeAt(1)!.asTextNode.text.spans.markers.isEmpty,
              true,
            );
          },
        );
        ...
        testWidgetsOnAllPlatforms(
          "toggles multiple attributions throughout multiple nodes",
          (tester) async {
            final TestDocumentContext context =
                await tester //
                    .createDocument()
          ...
          expect(
            SuperEditorInspector.findRichTextInParagraph("1")
                .getSpanForPosition(
                  TextPosition(
                    offset:
                        SuperEditorInspector.findTextInComponent("1").length -
                        1,
                  ),
                )
                ?.style
      ...
      group("doesn't apply attributions", () {
        testWidgetsOnAllPlatforms(
          "when typing before the start of the attributed text",
          (tester) async {
            await tester //
                .createDocument()
                .fromMarkdown("A **bold** text")
      ...
      group("doesn't clear attributions", () {
        testWidgetsOnAllPlatforms("when changing the selection affinity", (
          tester,
        ) async {
          final context =
              await tester //
    ...
    testWidgetsOnArbitraryDesktop('overwrites spans with different colors', (
      tester,
    ) async {
    ...
    testWidgetsOnArbitraryDesktop(
      'overwrites spans with different background colors',
      (tester) async {
                    ...
                    nodes: [
                      ParagraphNode(
                        ...
                        text: AttributedText(
                          'blue orange pink',
                          _createAttributedSpansForAttribution(
                            attribution: const BackgroundColorAttribution(
                              Colors.blue,
                            ),
                            startOffset: 0,
                            endOffset: 15,
    ...
    testWidgetsOnArbitraryDesktop('overwrites spans with different font sizes', (
      tester,
    ) async {
...
MutableDocument _paragraphFullBoldThenParagraph() => MutableDocument(
  nodes: [
    ...
    ParagraphNode(
      id: "2",
      text: AttributedText("This is the second node in a document."),
    ),
  ],
);
...
MutableDocument _paragraphFullyBoldThenParagraphPartiallyBold() =>
    MutableDocument(
      nodes: [
        ParagraphNode(
          id: "1",
...
MutableDocument _paragraphPartiallyBoldThenParagraphPartiallyBold() =>
    MutableDocument(
      nodes: [
        ParagraphNode(
          id: "1",

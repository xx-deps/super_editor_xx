...
MutableDocument singleBlockDoc() => MutableDocument(nodes: [HorizontalRuleNode(id: "1")]);
  ...
  nodes: [
    ParagraphNode(
      ...
      text: AttributedText(
        ...
        AttributedSpans(
          attributions: [
            const SpanMarker(attribution: ColorAttribution(Colors.orange), offset: 5, markerType: SpanMarkerType.start),
            const SpanMarker(attribution: ColorAttribution(Colors.orange), offset: 9, markerType: SpanMarkerType.end),
          ],
        ),
      ),
    ),
  ...
  nodes: [
    ParagraphNode(
      ...
      text: AttributedText(
        ...
        AttributedSpans(
          attributions: [
            const SpanMarker(attribution: ColorAttribution(Colors.orange), offset: 0, markerType: SpanMarkerType.start),
            const SpanMarker(attribution: ColorAttribution(Colors.orange), offset: 9, markerType: SpanMarkerType.end),
          ],
        ),
      ),
      ...
      text: AttributedText(
        ...
        AttributedSpans(
          attributions: [
            ...
            const SpanMarker(attribution: boldAttribution, offset: 36, markerType: SpanMarkerType.end),
          ],
        ),
      ),
    ),
    ...
    ParagraphNode(
      ...
      text: AttributedText(
        ...
        AttributedSpans(
          attributions: [
            const SpanMarker(attribution: boldAttribution, offset: 0, markerType: SpanMarkerType.start),
            const SpanMarker(attribution: boldAttribution, offset: 37, markerType: SpanMarkerType.end),
          ],
        ),
      ),
    ),

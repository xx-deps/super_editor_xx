  ...
  group('SuperEditor', () {
    group('inserts an image', () {
      testWidgetsOnAllPlatforms(
        'when the selection sits at the beginning of a non-empty paragraph',
        (tester) async {
          ...
          await tester.placeCaretInParagraph(
            context.findEditContext().document.first.id,
            0,
          );
      ...
      testWidgetsOnAllPlatforms(
        'when the selection sits at the middle of a paragraph',
        (tester) async {
          // Pump a widget with an arbitrary size for the images.
          final context =
              await tester //
      ...
      testWidgetsOnAllPlatforms(
        'when a downstream selection sits at the end of a paragraph',
        (tester) async {
          // Pump a widget with an arbitrary size for the images.
          final context =
              await tester //
      ...
      testWidgetsOnAllPlatforms(
        'when an upstream selection sits at the end of a paragraph',
        (tester) async {
          // Pump a widget with an arbitrary size for the images.
          final context =
              await tester //
...
Second paragraph""")
          ...
          await tester.placeCaretInParagraph(
            context.findEditContext().document.last.id,
            0,
          );
      ...
      testWidgetsOnAllPlatforms(
        'when the selection sits at an empty paragraph',
        (tester) async {
          // Pump a widget with an arbitrary size for the images.
          final context =
              await tester //
 ...
 Second paragraph""") //
    ...
    group('inserts a paragraph', () {
      testWidgetsOnDesktop('when the user presses ENTER at the end of an image', (
        tester,
      ) async {
      ...
      testWidgetsOnAndroid(
        'when the user presses the newline button on the software keyboard at the end of an image',
        (tester) async {
          final testContext = await tester
              .createDocument()
              .withCustomContent(

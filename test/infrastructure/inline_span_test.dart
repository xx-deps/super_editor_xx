...
void main() {
  group('SuperEditor > computeInlineSpan >', () {
    testWidgets(
      'computes inlineSpan for text with attributions and a placeholder at the beginning',
      (tester) async {
        ...
        expect(
          (spanList[2] as TextSpan).style!.fontWeight,
        ...
        expect(
          (spanList[4] as TextSpan).style!.fontWeight,
          equals(FontWeight.bold),
        );
      },
    );
    ...
    testWidgets(
      'computes inlineSpan for text with attributions and a placeholder at the middle',
      (tester) async {
        // Pump a widget because we need a BuildContext to compute the InlineSpan.
        await tester.pumpWidget(const MaterialApp());
        ...
        expect(
          (spanList[1] as TextSpan).style!.fontWeight,
          equals(FontWeight.bold),
        );
        ...
        expect(
          (spanList[5] as TextSpan).style!.fontWeight,
          equals(FontWeight.bold),
        );
      },
    );
    ...
    testWidgets(
      'computes inlineSpan for text with attributions and a placeholder at the end',
      (tester) async {
        // Pump a widget because we need a BuildContext to compute the InlineSpan.
        await tester.pumpWidget(const MaterialApp());
        ...
        expect(
          (spanList[3] as TextSpan).style!.fontWeight,
          equals(FontWeight.bold),
        );

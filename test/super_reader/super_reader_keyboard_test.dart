...
void main() {
  group('SuperReader keyboard >', () {
    ...
    group('moves selection >', () {
      testAllInputsOnDesktop(
        ...
        (tester, {required TextInputSource inputSource}) async {
          final nodeId = await _pumpSingleLineAndSelectAWord(
            tester,
            offset: 10,
          ...
          expect(
            ...
            _selectionInParagraph(nodeId, from: 8, to: 12),
          );
          ...
          expect(
            SuperReaderInspector.findDocumentSelection(),
            _selectionInParagraph(nodeId, from: 8, to: 11),
          );
        },
      );
      ...
      testAllInputsOnDesktop(
        ...
        (tester, {required TextInputSource inputSource}) async {
          ...
          expect(
            SuperReaderInspector.findDocumentSelection(),
            _selectionInParagraph(nodeId, from: 8, to: 13),
          );
        },
      );
        ...
        (tester, {required TextInputSource inputSource}) async {
          ...
          expect(
            ...
            _selectionInParagraph(
              ...
              from: 8,
              to: 5,
              toAffinity: TextAffinity.downstream,
            ),
          );
        },
      );
      ...
      testAllInputsOnApple(
        ...
        (tester, {required TextInputSource inputSource}) async {
          ...
          expect(
            SuperReaderInspector.findDocumentSelection(),
            _selectionInParagraph(nodeId, from: 8, to: 20),
          );
        },
      );
      ...
      testAllInputsOnApple(
        ...
        (tester, {required TextInputSource inputSource}) async {
          ...
          expect(
            SuperReaderInspector.findDocumentSelection(),
            _selectionInParagraph(nodeId, from: 8, to: 0),
          );
        },
      );
      ...
      testAllInputsOnDesktop(
        ...
        (tester, {required TextInputSource inputSource}) async {
          final nodeId = await _pumpDoubleLine(
            tester,
            offset: 44,
            inputSource: inputSource,
          );
          expect(
            SuperReaderInspector.findDocumentSelection(),
            _selectionInParagraph(nodeId, from: 41, to: 47),
          );
          ...
          expect(
            SuperReaderInspector.findDocumentSelection(),
            _selectionInParagraph(nodeId, from: 41, to: 18),
          );
        },
      );
      ...
      testAllInputsOnDesktop(
        ...
        (tester, {required TextInputSource inputSource}) async {
          ...
          expect(
            SuperReaderInspector.findDocumentSelection(),
            _selectionInParagraph(nodeId, from: 12, to: 17),
          );
          ...
          expect(
            SuperReaderInspector.findDocumentSelection(),
            _selectionInParagraph(nodeId, from: 12, to: 46),
          );
        },
      );
    ...
    testAllInputsOnApple(
      "and removes selection when it collapses without holding the SHIFT key",
      (tester, {required TextInputSource inputSource}) async {
        final nodeId = await _pumpSingleLineAndSelectAWord(
          tester,
          offset: 10,
    ...
    testAllInputsOnApple(
      "and retains the selection when collapsed and the SHIFT key is pressed",
      (tester, {required TextInputSource inputSource}) async {
        final nodeId = await _pumpSingleLineAndSelectAWord(
          tester,
          offset: 10,

...
void main() {
  group('SuperReader gestures', () {
    testWidgetsOnDesktop(
      'scrolls the content when dragging the scrollbar (downstream)',
      (tester) async {
        ...
        final startingDragLocation =
            tester.getTopRight(find.byType(SuperReader)) +
            const Offset(-10, 10);
        ...
        // Move the thumb down.
        await tester.sendEventToBinding(
          testPointer.move(startingDragLocation + const Offset(0, 300)),
        );
        await tester.pump();
    ...
    testWidgetsOnDesktop(
      'scrolls the content when dragging the scrollbar (upstream)',
      (tester) async {
        final scrollController = ScrollController();
        await tester //
            .createDocument()
        ...
        // Find the approximate position of the scrollbar thumb.
        final startingDragLocation =
            tester.getBottomRight(find.byType(SuperReader)) -
            const Offset(10, 10);

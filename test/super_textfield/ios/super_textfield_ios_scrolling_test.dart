...
void main() {
  group("SuperTextField > scrolling >", () {
    testWidgetsOnIos('auto-scrolls to caret position upon widget initialization', (
      tester,
    ) async {
    ...
    testWidgetsOnIos('single-line drag does nothing without a selection', (
      tester,
    ) async {
    ...
    testWidgetsOnIos('single-line drag does nothing with collapsed selection', (
      tester,
    ) async {
      // Test explanation: I experimented with single-line text fields in a few iOS apps
      // and I found that dragging in an area away from the caret doesn't have any effect.

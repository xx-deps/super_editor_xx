...
void main() {
  group('ImeAttributedTextEditingController', () {
    ...
    testWidgetsOnAllPlatforms('doesn\'t send existing IME value back to IME', (
      tester,
    ) async {
    ...
    test(
      'clears composing attributions by deleting individual styled characters',
      () {
    ...
    test('replaces selected text with batch of new text', () {
      ...
      expect(
        controller.selection,
        equals(const TextSelection.collapsed(offset: 4)),
      );
    });
  ...
  testWidgets('isn\'t notified by inner controller after disposal', (
    tester,
  ) async {
    ...
    ImeAttributedTextEditingController imeController =
        ImeAttributedTextEditingController(

...
void main() {
  group('SuperTextField', () {
    testWidgetsOnAllPlatforms(
      'single-line jumps scroll position horizontally as the user types',
      (tester) async {
        ...
        final viewportRight = tester
            .getBottomRight(find.byType(SuperTextField))
            .dx;
    ...
    testWidgetsOnAllPlatforms(
      'multi-line jumps scroll position vertically as the user types',
      (tester) async {
        final controller = AttributedTextEditingController(
    ...
    testWidgetsOnAllPlatforms(
      "multi-line doesn't jump scroll position vertically when selection extent is visible",
      (tester) async {
        final controller = AttributedTextEditingController(
          text: AttributedText(
            "First line\nSecond Line\nThird Line\nFourth Line",
    ...
    testWidgetsOnDesktop("doesn't scroll vertically when maxLines is null", (
      tester,
    ) async {
      ...
      final viewportHeight = tester
          .getRect(find.byType(SuperTextFieldScrollview))
          .height;

      final layoutState =
          (find.byType(SuperDesktopTextField).evaluate().single
                      as StatefulElement)
                  .state
              as SuperDesktopTextFieldState;
      final contentHeight = layoutState.textLayout.getLineHeightAtPosition(
    ...
    testWidgetsOnDesktop(
      ...
      (tester) async {
        ...
        final scrollOffsetInMiddleOfMomentum =
    ...
    testWidgetsOnMobile(
      "multi-line is vertically scrollable when text spans more lines than maxLines",
      (tester) async {
        const initialText =

...
void main() {
  ...
  testWidgetsOnMac(
    'prevents surrounding widgets from consuming control keys that trigger OS selectors',
    (tester) async {
              ...
              actions: {
                DismissIntent: CallbackAction<DismissIntent>(
                  onInvoke: (DismissIntent intent) {
                    fail(
                      "Received a DismissIntent from Shortcuts but that shortcut should never have been activated.",
                    );
                  },
                ),
              },
